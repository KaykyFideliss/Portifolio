  ...
  return (
    <header className="flex justify-between items-center py-4 px-4 lg:px-20">
      ...
      <div className="hidden md:flex gap-20 items-center">
        ...
        <a className="text-base tracking-wider transition-colors hover:text-[#00aaff] font-poppins" href="#servicos">Serviços</a>
      ...
      {open && (
        <div className="absolute top-0 left-0 w-full h-screen bg-[#000000] flex flex-col items-center justify-center gap-10 text-xl z-40">
          ...
          <a onClick={() => setOpen(false)} className="hover:text-[#00aaff] font-poppins" href="#sobre"
          onClick={(e) => { e.preventDefault(); document.getElementById("about").scrollIntoView({ behavior: "smooth" });}}>
            Sobre</a>
          <a onClick={() => setOpen(false)} className="hover:text-[#00aaff] font-poppins" href="#servicos">Serviços</a>
