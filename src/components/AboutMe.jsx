    ...
    <section id="about"className="flex w-full min-h-screen mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-transparent" >
      ...
      <div className="flex flex-col lg:flex-row items-center gap-y-6 lg:gap-x-8 text-black p-8 rounded-2xl shadow-lg ">
          ...
          <div className="flex-1 flex justify-center">
            <img
              src="https://avatars.githubusercontent.com/u/79857336?v=4"
              alt="Foto de Kayky"
              className="w-90 h-90 object-cover rounded-2xl shadow-xl"
            />
          </div>

          {/* Texto */}
          <div className="flex-1 text-center md:text-center lg:text-justify">
            <h3 className=" pt-8 text-3xl font-semibold mb-4 text-white font-syncopate">
              Olá, eu sou Kayky
            </h3>
            <p className="text-lg leading-relaxed text-white font-poppins text-justify ">
              ...
              em Informática integrado ao ensino médio. <br />
              <br />
