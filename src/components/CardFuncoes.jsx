...
<div className="w-full max-w-[900px] text-center mb-12 px-4">
 <h2 className="pt-10 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white font-syncopate break-words">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 px-4 max-w-[1200px]">
      ...
      {/* SpotlightCard logo abaixo de Project */}
   <SpotlightCard
...
>
  <div className="p-6">
    ...
    <h2 className="text-3xl font-bold font-poppins text-white">Criação de Landing page</h2>
    </div>
    <p className="text-gray-300 mt-2 font-poppins text-sm">
...
>
  <div className="p-6">
    ...
    <p className="text-gray-300 mt-2 font-poppins text-sm ">
     Design de interfaces elegantes e funcionais, proporcionando experiência do usuário envolvente e identidade visual consistente.
    </p>
  </div>
</SpotlightCard>
